...
const MODE_INTROS = {
  ...
  listen:{icon:'👂',title:'Tune your ear — comprehension first',body:'You already understand more than you can say — this mode activates that. Read a real line from the podcast, predict what it means before revealing, and choose among possible meanings. Toggle the phonetic and Arabic layers to make it harder or easier. No speaking, no pressure.',tip:'Prediction before confirmation is what turns passive understanding into active recall. Guess FIRST, even when unsure — the guess is the exercise.'},
